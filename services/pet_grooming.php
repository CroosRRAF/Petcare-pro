    ...
    <div class="services-container">
        ...
        <div class="page-header">
            <div class="header-content">
                <h1>
                    <i class="fas fa-cut"></i> Pet Grooming Services
                </h1>
            </div>
        </div>
        ...
        <div class="services-grid">
                    ...
                    <div class="service-card">
                        ...
                        <div class="card-content">
                            <div class="card-header">
                                <span class="badge badge-primary">Grooming</span>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <h3>No grooming services available</h3>
                    <p>Please check back later for our grooming services.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
